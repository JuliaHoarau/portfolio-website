  ...
  return (
    <div className="bg-primary">
      <div className="relative h-screen flex grid grid-cols-3 grid-rows-3">
        ...
        <motion.div className="hidden md:flex col-start-1 row-start-1 w-full h-full flex justify-start items-start m-1"
        ...
        <motion.div className="hidden md:flex col-start-3 row-start-3 w-full h-full flex justify-end items-end m-1"
                     initial={initial} animate={animate}>
